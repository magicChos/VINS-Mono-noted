...
// 优化变量主要包括i，j时刻的p、q、v、b_a、b_g
// [p_bk^w,q_bk^w],[v_bk^w,b_ak,b_wk],[p_bk+1^w,q_bk+1^w],[v_bk+1^w,b_ak+1,b_wk+1]
// 7指的是[p_bk^w,q_bk^w]维度
// 9指的是[v_bk^w,b_ak,b_wk]维度
// 7指的是[p_bk+1^w,q_bk+1^w]维度
// 9指的是[v_bk+1^w,b_ak+1,b_wk+1]维度
